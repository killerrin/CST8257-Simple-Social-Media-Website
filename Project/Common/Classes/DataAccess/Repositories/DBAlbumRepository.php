...
class DBAlbumRepository extends DBGenericRepository
{
    ...
    private function rowToObject($row) : Album {
    ...
    public function getAllForUserAccessibility($userId, $accessibilityCode) : array
    {
        $query = "SELECT * FROM $this->tableName
                  WHERE
    ...
    public function insert(Album $item) {
    ...
    public function update(Album $item) {
