...
class Picture {
    ...
    public static function createAlbumFilePath($fileName) { return ALBUM_PICTURES_DIR."/".$fileName; }
    public static function createThumbnailFilePath($fileName) { return ALBUM_THUMBNAILS_DIR."/".$fileName; }
    public static function createOriginalFilePath($fileName) { return ORIGINAL_PICTURES_DIR."/".$fileName; }
    public function getAlbumFilePath() { return Picture::createAlbumFilePath($this->fileName); }
    public function getThumbnailFilePath() { return Picture::createThumbnailFilePath($this->fileName); }
    public function getOriginalFilePath() { return Picture::createOriginalFilePath($this->fileName); }
}
?>